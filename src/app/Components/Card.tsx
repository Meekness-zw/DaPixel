...
function Card(props: Card) {
    return (
        <div className='flex justify-center items-center mt-20 lg:justify-end'>
            <div className="relative flex shadow-md w-[95%] md:w-[80%] lg:w-[70%]">
                ...
                <p className='absolute text-[#F9BC6E] text-6xl font-extrabold opacity-[45%] -top-12 -right-5'>{props.num}</p>
            </div>
        </div>
    )
}
